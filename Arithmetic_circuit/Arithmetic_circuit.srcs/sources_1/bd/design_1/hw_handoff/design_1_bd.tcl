...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BRAM_ADDR [ create_bd_port -dir O -from 12 -to 0 BRAM_ADDR ]
  set BRAM_CLK [ create_bd_port -dir O -type clk BRAM_CLK ]
  set BRAM_RST [ create_bd_port -dir O -type rst BRAM_RST ]
  set BRAM_R_DATA [ create_bd_port -dir I -from 31 -to 0 BRAM_R_DATA ]
  set BRAM_WE [ create_bd_port -dir O -from 3 -to 0 BRAM_WE ]
  set BRAM_W_DATA [ create_bd_port -dir O -from 31 -to 0 BRAM_W_DATA ]
  set clk0 [ create_bd_port -dir O -type clk clk0 ]
  set clk1 [ create_bd_port -dir O -type clk clk1 ]
  set rst0 [ create_bd_port -dir O -type rst rst0 ]
  set rst1 [ create_bd_port -dir O -type rst rst1 ]
  ...
  connect_bd_net -net BRAM_R_DATA_1 [get_bd_ports BRAM_R_DATA] [get_bd_pins axi_bram_ctrl_0/bram_rddata_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_ports BRAM_ADDR] [get_bd_pins axi_bram_ctrl_0/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_ports BRAM_CLK] [get_bd_pins axi_bram_ctrl_0/bram_clk_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_ports BRAM_RST] [get_bd_pins axi_bram_ctrl_0/bram_rst_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_ports BRAM_WE] [get_bd_pins axi_bram_ctrl_0/bram_we_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_ports BRAM_W_DATA] [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clk0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports clk1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports rst0] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_FCLK_RESET1_N [get_bd_ports rst1] [get_bd_pins processing_system7_0/FCLK_RESET1_N]
